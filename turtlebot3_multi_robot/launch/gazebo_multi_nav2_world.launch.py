...
def generate_launch_description():
    ...
    robots = [
        {'name': 'tb3_0', 'x_pose': '-1.5', 'y_pose': '-0.5', 'z_pose': 0.01},
        {'name': 'tb3_1', 'x_pose': '-1.5', 'y_pose': '0.5', 'z_pose': 0.01}
        ]
    ...
    last_action = None
    # Spawn turtlebot3 instances in gazebo, and robots_state node
    for robot in robots:
